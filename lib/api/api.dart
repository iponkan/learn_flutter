class Api {
  static final String baseUrl = 'http://118.126.101.112:3000/';
  // static final String baseUrl = 'http://yapi.demo.qunar.com/mock/89510/';
  static final String action = 'client.action';
  static final String appCenterInfo =
      'client.action?functionId=newAppCenterInfo';
  ...
  static final String subcateoryList =
      '/client.action?functionId=newSubCatalog';
  static final String swipperImageList =
      'client.action?functionId=getCmsPromotionsListByCatelogyID';
  static final String recommendItemList =
      'client.action?functionId=uniformRecommend';
